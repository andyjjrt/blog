<template>
  <div class="navbar bg-base-200 sticky top-0">
    <div class="grow">
      ...
      <ul class="nav-menu">
        <li>
          <NuxtLink to="/" class="btn btn-ghost">Posts</NuxtLink>
        </li>
        <li>
    ...
    <div class="">
      <label class="swap swap-rotate px-6">
        ...
        <!-- sun icon -->
        <svg class="fill-current w-10 h-10" :class="{ 'swap-off': dark.value, 'swap-on': !dark.value }"
        ...
        <!-- moon icon -->
        <svg class="fill-current w-10 h-10" :class="{ 'swap-on': dark.value, 'swap-off': !dark.value }"
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path
